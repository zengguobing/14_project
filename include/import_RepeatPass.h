...
#include "ui_import_RepeatPass.h"
#include"MyThread.h"

class import_RepeatPass : public QWidget
{
    Q_OBJECT
public:
    explicit import_RepeatPass(QWidget* parent = Q_NULLPTR);
    ~import_RepeatPass();
public slots:
...
private:
    Ui::import_RepeatPass* ui;
    QString save_path;
    QStandardItemModel* copy;
    MyThread* import_RepeatPass_thread;
signals:
